...
public class CashActivity extends AppCompatActivity {
    ...
    public String FY;
    public String CAT;
    private ArrayList<CashdataModel> order_list = new ArrayList<>();
...
//        });
    ...
    //recyclerview
    private void setRecyclerView(ArrayList<CashdataModel> order_list) {
